...
{
    public class SymbolicLinkLogReparseOutputTests
    {
        private readonly static Fixture AutoFixture = new();

        [Fact]
        public void When_reparsepoint_is_not_symboliclinkreparsepoint_then_throw_argumentexception()
        {
            using var autoSub = new AutoSubstitute();

            var data = autoSub.Resolve<IFakeReparsePoint>();

            var sut = autoSub.Resolve<SymbolicLinkLogReparseOutput>();
        ...
        [Fact]
        public void When_reparsepoint_is_symboliclinkreparsepoint_then_call_loginformation()
        {
            using var autoSub = new AutoSubstitute();
            ...
            var data = autoSub.Resolve<ISymbolicLinkReparsePoint>();
